...
const handleDeleteSubSection = async (subSectionId, sectionId) => {
    ...
    if (result) {
        ...
        // Create an updated course object with the new content
        const updatedCourse = { ...course, courseContent: updatedCourseContent };

        // Dispatch the updated course to the Redux store
        dispatch(setCourse(updatedCourse));

        // Optionally hide the confirmation modal
        setConfirmationModal(null);
    }
};
  ...
  return (
    <div  className="border border-pink-600">
              ...
              <div className='rounded-lg bg-richblack-700 text-white p-6 px-8'>
